        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                ...
                $model->phone = substr($model->phone, -10);
                if ($model->save()) {
                    return [
                        'forceReload' => '#crud-datatable-pjax',
                        'title' => "Добавить пользователя",
                        'content' => '<span class="text-success">Пользователь создан</span>',
                        'footer' =>
                ...
                return [
                    ...
                    'footer' => Html::button('Редактировать', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
                        Html::button('Сохранить', ['class' => 'btn btn-primary', 'type' => "submit"])
            ...
            if ($request->isGet) {
                ...
                if ($model->save()) {
                    return [
                        ...
                        'footer' =>
                            Html::button(
                                'Закрыть', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]
                            ) .
                            Html::a(
                                'Редактировать',
                ...
                return [
                    ...
                    'footer' =>
                        ...
                        Html::button(
                            'Сохранить', ['class' => 'btn btn-primary', 'type' => "submit"]
                        )
                ];
            }
        } else {

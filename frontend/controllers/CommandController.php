...
class CommandController extends Controller
{
            ...
            */
            ...
            if ($request->isGet) {
                return [
                    ...
                    'footer' => Html::button('Закыть', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
                ...
                return [
                    ...
                    'title' => "Добавить команду",
                    'content' => '<span class="text-success">Create Command success</span>',
                    'footer' => Html::button('Закыть', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
            ...
            */
            ...
            if ($request->isGet) {
                return [
                    ...
                    'footer' =>
                        Html::button('Закыть', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
                        Html::button('Сохранить', ['class' => 'btn btn-primary', 'type' => "submit"])
                ];
            } else if ($model->load($request->post()) && $model->save()) {
                return [
    ...
    /**
     * Delete an existing Command model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Command model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
